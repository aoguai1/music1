package com.example.szq.music1.service;
...
import com.example.szq.music1.IMusicPlayerService;
import com.example.szq.music1.R;
import com.example.szq.music1.activity.AudioPlayerActivity;
import com.example.szq.music1.domain.MediaItem;
...
/**
 * Created by szq on 18-9-27.
 */

public class MusicPlayerService extends Service {

    public static final String OPENAUDIO = "com.sun.mobileplayer_OPENAUDIO";
...
//                 mediaPlayer.release();
    ...
    private void start(){
        ...
        @SuppressLint("WrongConstant") NotificationChannel channel = new NotificationChannel("1", "Channel1", NotificationManager.IMPORTANCE_DEFAULT);
        channel.enableLights(true); //是否在桌面icon右上角展示小红点 channel.setLightColor(Color.GREEN); //小红点颜色 channel.setShowBadge(true); //是否在久按桌面图标时显示此渠道的通知 notificationManager.createNotificationChannel(channel);
