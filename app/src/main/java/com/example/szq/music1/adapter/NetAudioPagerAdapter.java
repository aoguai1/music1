package com.example.szq.music1.adapter;
    ...
    private void bindData(int itemViewType, ViewHolder viewHolder, NetAudioPagerData.ListEntity mediaItem) {
        switch (itemViewType) {
            ...
            case TYPE_IMAGE://图片
                ...
                int  height = mediaItem.getImage().getHeight()<= DensityUtil.getScreenHeight()*0.35?mediaItem.getImage().getHeight(): (int) (DensityUtil.getScreenHeight()*0.35);
